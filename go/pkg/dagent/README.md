...
| DAGENT_IMAGE           | Fully qualified image name with registry incl. without protocol                                               | registry.gitlab.com/dyrector_io/dyrector.io/go/dagent |
...
docker run \
  ...
  -d  \
  registry.gitlab.com/dyrector_io/dyrector.io/go/dagent:latest
```
