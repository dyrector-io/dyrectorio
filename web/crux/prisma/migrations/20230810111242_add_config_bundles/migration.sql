...
-- AddForeignKey
ALTER TABLE "ConfigBundleOnDeployments" ADD CONSTRAINT "ConfigBundleOnDeployments_configBundleId_fkey" FOREIGN KEY ("configBundleId") REFERENCES "ConfigBundle"("id") ON DELETE CASCADE ON UPDATE CASCADE;
