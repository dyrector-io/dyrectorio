...
import { DeploymentStatusMessage, ContainerStatusListMessage } from '../proto/crux'
...
const baseVersionDeployRequest: object = { id: '', versionName: '', releaseNotes: '' }
...
export const DeployRequest_InstanceConfig = {
  fromJSON(object: any): DeployRequest_InstanceConfig {
    const message = { ...baseDeployRequest_InstanceConfig } as DeployRequest_InstanceConfig
...
export const DeployRequest_InstanceConfig_Environment = {
  fromJSON(object: any): DeployRequest_InstanceConfig_Environment {
    const message = { ...baseDeployRequest_InstanceConfig_Environment } as DeployRequest_InstanceConfig_Environment
...
const baseDeployRequest_ContainerConfig: object = { name: '', mounts: '', environments: '', user: 0 }

export const DeployRequest_ContainerConfig = {
  fromJSON(object: any): DeployRequest_ContainerConfig {
    const message = { ...baseDeployRequest_ContainerConfig } as DeployRequest_ContainerConfig
...
const baseDeployRequest_ContainerConfig_Port: object = { internal: 0, external: 0 }

export const DeployRequest_ContainerConfig_Port = {
  fromJSON(object: any): DeployRequest_ContainerConfig_Port {
    const message = { ...baseDeployRequest_ContainerConfig_Port } as DeployRequest_ContainerConfig_Port
...
const baseDeployRequest_ContainerConfig_Expose: object = { public: false, tls: false }

export const DeployRequest_ContainerConfig_Expose = {
  fromJSON(object: any): DeployRequest_ContainerConfig_Expose {
    const message = { ...baseDeployRequest_ContainerConfig_Expose } as DeployRequest_ContainerConfig_Expose
...
const baseDeployRequest_ContainerConfig_ConfigContainer: object = { image: '', volume: '', path: '', keepFiles: false }
...
const baseDeployRequest_RegistryAuth: object = { name: '', url: '', user: '', password: '' }

export const DeployRequest_RegistryAuth = {
  fromJSON(object: any): DeployRequest_RegistryAuth {
    const message = { ...baseDeployRequest_RegistryAuth } as DeployRequest_RegistryAuth
    message.name = object.name !== undefined && object.name !== null ? String(object.name) : ''
