...
import { DeploymentProgressMessage, NodeConnectionStatus, NodeEventMessage } from 'src/proto/proto/crux'
...
export class Agent {
  ...
  constructor(connection: GrpcNodeConnection, private readonly eventChannel: Subject<NodeEventMessage>) {
