...
import { cursorPointer } from '@app/utils'
...
const NotificationCard = (props: NotificationCardProps) => {
  ...
  const getDefaultImage = () => {
    return <Image src="/notification.svg" width={17} height={21} alt={t('altNotificationPicture')} />
  }

  return (
    <DyoCard className={clsx(props.className ?? 'p-6', 'flex flex-col')}>
      <div className={clsx('flex flex-row flex-grow', cursorPointer(props.onClick))}>
        {getDefaultImage()}
      ...
      <div className="flex flex-row flex-grow justify-end">
        <DyoLabel className="mr-4 mt-auto py-0.5 leading-4">{t('common:createdBy', { name: props.notification.createdBy })}</DyoLabel>
