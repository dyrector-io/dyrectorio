...
import CreateDeploymentTokenCard from '@app/components/deployments/create-deployment-token-card'
import DeploymentDetailsSection from '@app/components/deployments/deployment-details-section'
import DeploymentTokenCard from '@app/components/deployments/deployment-token-card'
import EditDeploymentCard from '@app/components/deployments/edit-deployment-card'
import EditDeploymentInstances from '@app/components/deployments/edit-deployment-instances'
import useDeploymentState from '@app/components/deployments/use-deployment-state'
...
const DeploymentDetailsPage = (props: DeploymentDetailsPageProps) => {
  ...
  const onDeploy = async () => {
    ...
    if (state.selectedInstanceIds.length < 1) {
