...
test('Add incremental version should work', async ({ page }) => {
  ...
  await page.goto(routes.project.details(projectId))
...
test("New version should get the default version's images and deployments", async ({ page }) => {
  ...
  await page.goto(routes.project.versions(projectId, childVersion, { section: 'images' }))
  ...
  await page.goto(routes.project.versions(projectId, childVersion, { section: 'deployments' }))
...
test('Change default version should work', async ({ page }) => {
  ...
  await page.goto(routes.project.versions(projectId, versionThree, { section: 'images' }))
