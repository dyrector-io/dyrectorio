...
func (s *Secret) BackupSecretsToVault(ctx context.Context, namespace, containerName string, secrets map[string]string) error {
	...
	// Backup to vault
	_, _, err = vault.UpsertSecureNote(ctx,
		session,
