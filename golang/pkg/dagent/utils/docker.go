...
func DeployImage(ctx context.Context,
	...
	err = saveSecretsToVault(ctx, prefix, containerName, secrets, cfg.SecretVault)
...
func saveSecretsToVault(ctx context.Context, prefix, name string, secrets map[string]string, vaultCfg internalConfig.Vault) error {
