...
var (
	...
	ErrServerVersionMismatch = errors.New("bwcli: server does not support this CLI version (userDecryptionOptions missing); upgrade the server or downgrade the bw CLI")
)
