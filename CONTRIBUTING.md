...
Submitting pull requests require all commits to be signed with a GPG signature. Refer to this [GitHub documentation](https://docs.github.com/en/authentication/managing-commit-signature-verification) to setup the GPG signing.
