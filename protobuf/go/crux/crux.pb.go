...
var file_protobuf_proto_crux_proto_depIdxs = []int32{
	...
	8,  // 75: crux.CruxDeployment.SubscribeToDeploymentEvents:input_type -> crux.IdRequest
	7,  // 76: crux.CruxDeployment.SubscribeToDeploymentEditEvents:input_type -> crux.ServiceIdRequest
	65, // 77: crux.CruxHealth.getHealth:input_type -> common.Empty
	38, // 78: crux.CruxNode.SubscribeNodeEventChannel:output_type -> crux.NodeEventMessage
	66, // 79: crux.CruxNode.WatchContainerState:output_type -> common.ContainerStateListMessage
	67, // 80: crux.CruxNode.SubscribeContainerLogChannel:output_type -> common.ContainerLogMessage
	41, // 81: crux.CruxDeployment.SubscribeToDeploymentEvents:output_type -> crux.DeploymentProgressMessage
	43, // 82: crux.CruxDeployment.SubscribeToDeploymentEditEvents:output_type -> crux.DeploymentEditEventMessage
	48, // 83: crux.CruxHealth.getHealth:output_type -> crux.HealthResponse
