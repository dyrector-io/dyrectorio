...
var doc = `{
    ...
    "definitions": {
        ...
        "gitlab.com_dyrector_io_co_pkg_api_v1.Probe": {
            "type": "object",
            "properties": {
                "path": {
                    "type": "string"
        ...
        "gitlab.com_dyrector_io_co_pkg_api_v1.Volume": {
            "type": "object",
            "required": [
                "path"
            ],
        ...
        "v1.ContainerConfig": {
            ...
            "properties": {
                ...
                "volumes": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab.com_dyrector_io_co_pkg_api_v1.Volume"
                    }
                }
            }
        },
        ...
        "v1.HealthCheckConfig": {
            ...
            "properties": {
                ...
                "livenessProbe": {
                    "$ref": "#/definitions/gitlab.com_dyrector_io_co_pkg_api_v1.Probe"
                },
                "readinessProbe": {
                    "$ref": "#/definitions/gitlab.com_dyrector_io_co_pkg_api_v1.Probe"
                },
