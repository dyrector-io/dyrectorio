...
func TestJWTValidation(t *testing.T) {
	tests := []jwtTest{
		...
		{
			name:                "PS384 token without signature",
		...
		{
			name:                "invalid token without the header",
			jwtTokenStringified: "eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.bQTnz6AuMJvmXXQsVPrxeQNvzDkimo7VNXxHeSBfClLufmCVZRUuyTwJF311JHuh",
			valid:               false,
		},
	}
